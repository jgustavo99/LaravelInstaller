...
Route::group(['prefix' => 'install','as' => 'LaravelInstaller::','namespace' => 'jgustavo99\LaravelInstaller\Controllers','middleware' => ['web', 'install']], function() {
    Route::get('/', [
        'as' => 'welcome',
...
Route::group(['prefix' => 'update','as' => 'LaravelUpdater::','namespace' => 'jgustavo99\LaravelInstaller\Controllers','middleware' => 'web'],function() {
